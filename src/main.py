#importing library called flask, which is a web application 
# (something that recieves requests from a browser and responses from a program)
...
#If statement is a safety check to make sure flask only runs when the file is run directly 
#and not imported from another file
